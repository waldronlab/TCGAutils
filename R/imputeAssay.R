...
#'
#' @param multiassayexperiment A `MultiAssayExperiment` with genes in the rows,
#'   samples in the columns
#'
#' @param i A numeric, logical, or character `vector` indicating the assays to
#'   perform imputation on (default 1L)
#'
